...
trait Zamartz_API_Methods
{
    ...
    {
        if ($message == '' || $this->is_cron_log !== 'yes' || WP_DEBUG !== true || WP_DEBUG_LOG != true) {
            return;
        }
    ...
    public function set_api_license_key_ajax()
    {
        ...
        if (!empty($response_data->success) && $response_data->success === true) {
            if (isset($response_data->activated) && $response_data->activated === true) {
                ...
                update_option($this->plugin_input_prefix . 'api_license_key', '');
                update_option($this->plugin_input_prefix . 'api_password', '');
                update_option($this->plugin_input_prefix . 'api_product_id', '');
                update_option($this->plugin_input_prefix . 'api_purchase_emails', '');
            ...
            $message = __('Success: Activation of your API has been successful', "wp-zamartz-admin");
